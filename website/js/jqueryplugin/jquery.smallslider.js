(function($) {
	...
	var _this = this;
	    ...
	    _this.createButtons = function()
	    {
		    ...
		    buttons ='<div class="slide_btns">' + buttons + '</div>';
		    ...
		    _this.$btns.eq(0).addClass('current');
	    ...
	    $('<div class="smallslider-tex slide_lay"></div>').css(style_tex).css({
		opacity:0.39
	    }).appendTo(_this.$elm);
	    ...
	    _this.$lay = _this.$elm.find('div.slide_lay');
	    ...
	    {
		_this.$btns.removeClass('current');
		_this.$btns.eq(index).addClass('current');
	    }
